...
import robot from "../assets/svg/projects/robot.png";
export const projectsData = [
  {
    id: 1,
    projectName: "MealGenie App",
    projectDesc:
      "I've built a personal app named Mealginie to plan my daily meals efficiently. It suggests recipes that allow me to cook once for the entire day based on the items I choose to consume.",
    tags: ["generativeAi", "Node-TS", "ViteTS", "Docker"],
    code: "https://github.com/ShravyaKudlu/MealGenie",
    demo: "https://drive.google.com/file/d/1FPg0TpI0dG1g2spMmDzsPie3JMzQTbBd/view?usp=drive_link",
    image: robot,
  },
  {
    id: 2,
    ...
    projectDesc:
      'This project aims to build a Blog Application where users can post and comment on a blog with a build in moderation service automatically remove\'s the comment "Orange".',
  ...
  },
  {
    ...
    projectDesc:
      "In Schrödinger Hackathon I was recognized for creating a practical application showcasing chemical elements and their perturbations. This app, featuring a demo page, served as a valuable tool for chemists, drawing inspiration from industry insights.",
  ...
  },
  {
    ...
    projectDesc:
      "Implemented Amazon AWS S3 replication with strict 5-second request fulfillment for local and remote access. Maintained memory efficiency within a 2MB heap. Ensured data security by avoiding local storage of remotely fetched files.",
  ...
  },
  {
    ...
    projectDesc:
      "A simple project to understand SQL queries and structure of relational databases",
  ...
  },
  {
    ...
    projectDesc:
      "Analyzed customer reviews on womens E-Commerce platform using multinomial naive bayes",
    tags: ["python", "Jupyter"],
  ...
  },
  {
    ...
    projectDesc:
      "Developed a camera-based system to extract heart rate from facial skin color variations. Implemented Fast Fourier Transformation, Principal Component Analysis, and Independent Component Analysis algorithms for accurate and noise-free results.",
    tags: ["python", "Jupyter"],
